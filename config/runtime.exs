...
if config_env() == :prod do
  ...
  #
  #     config :phoenix_nextjs, PhoenixNextjs.Mailer,
...
# Enable the server for all environments
config :phoenix_nextjs, PhoenixNextjsWeb.Endpoint, server: true
...
config :phoenix_nextjs, PhoenixNextjs.Repo,
  ...
  database: System.get_env("DB_NAME") || "phoenix_nextjs_#{config_env()}",
  stacktrace: true,
...
config :phoenix_nextjs, PhoenixNextjsWeb.Endpoint,
  ...
  live_view: [
    signing_salt:
      System.get_env("SIGNING_SALT") || raise("environment variable SIGNING_SALT is missing.")
  ]
